...
+function (ns) {
  ...
  var listener = {};
  var thread = new HtmlWorker(Gov.getAbsolutePath("./HbeatCore.js"));//../../../static/js/ws/HbeatCore.js  
  console.log(Gov.getAbsolutePath("./static/js/ws/HbeatCore.js"));
  console.log(Gov.getAbsolutePath("HbeatCore.js"));
  console.log(Gov.getAbsolutePath("../../../static/js/ws/HbeatCore.js"));
  var wsState = {
    conn: 1,
    unconn: 0
